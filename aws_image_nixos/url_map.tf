...
variable "url_map" {
  ...
  default = {
    ...
    "latest.ap-northeast-1.hvm-ebs" = "ami-00db62688900456a4"
    "latest.ap-northeast-2.hvm-ebs" = "ami-0485cdd1a5fdd2117"
    "latest.ap-south-1.hvm-ebs"     = "ami-0303deb1b5890f878"
    "latest.ap-southeast-1.hvm-ebs" = "ami-0cff66114c652c262"
    "latest.ap-southeast-2.hvm-ebs" = "ami-054c73a7f8d773ea9"
    "latest.ca-central-1.hvm-ebs"   = "ami-03f9fd0ef2e035ede"
    "latest.eu-central-1.hvm-ebs"   = "ami-0022b8ea9efde5de4"
    "latest.eu-west-1.hvm-ebs"      = "ami-0fe40176548ff0940"
    "latest.eu-west-2.hvm-ebs"      = "ami-03a40fd3a02fe95ba"
    "latest.eu-west-3.hvm-ebs"      = "ami-0436f9da0f20a638e"
    "latest.sa-east-1.hvm-ebs"      = "ami-0c6a43c6e0ad1f4e2"
    "latest.us-east-1.hvm-ebs"      = "ami-0efc58fb70ae9a217"
    "latest.us-east-2.hvm-ebs"      = "ami-0abf711b1b34da1af"
    "latest.us-west-1.hvm-ebs"      = "ami-07d126e8838c40ec5"
    "latest.us-west-2.hvm-ebs"      = "ami-03f8a737546e47fb0"
  }
